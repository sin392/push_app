<header class="header">
    ...
    <div>
        <div class='nav-items'>
            ...
            <a href="/form" style="text-decoration:none; color: inherit; display: inline-block;">Form</a>
            <a href="/list/messages" style="text-decoration:none; color: inherit; display: inline-block;">View</a>
        </div>
